...
export type ParamType = { name: string, parent?: string, children?: ParamType[] }
        ...
        function unroll(param : ParamType) : ReactNode {
            ...
            return ( 
                <InputSection indent={!!param.children}> 
                    ...
                    {param.name && <input name={param.name} type="text" onChange={handleInput} value={inputs ? inputs[p.name] : ""}/>}
                </InputSection>
            )
        }
